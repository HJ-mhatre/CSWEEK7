...
Age_at_Inauguration1<-as.numeric(Age_at_Inauguration)
...
presidents_age_as_of_today_in_weeks1<-as.numeric(presidents_age_as_of_today_in_weeks)



US_Presidential_Info<-data.frame(Name,Term,Place_of_birth,Date_of_Birth,Age_at_Inauguration1,presidents_age_as_of_today_in_weeks1)

US_Presidential_Info

library(ggplot2)

ggplot(US_Presidential_Info, aes(x=Age_at_Inauguration1, y=presidents_age_as_of_today_in_weeks1))  + geom_point(color="RED", size=1) + geom_smooth(method='lm', se=FALSE)
